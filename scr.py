...
sleep_time = 0
try:
    sleep_time = int(input("Sleep time (default 0: "))
except Exception as e:
    print("Input right value" + str(e))

# Sleep after or before click
# when = True
# try:
#    when = input("Sleep after or before click(default after). Input 'b' if before else input 'a'")
# except Exception as e:
#   print("Input right value" + str(e))
